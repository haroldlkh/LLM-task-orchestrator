...
def default_runtime(step_config: dict) -> dict:
    ...
    merged = {
        ...
        "keep_last_results_checkpoints": int(runtime.get("keep_last_results_checkpoints", runtime.get("keep_last_flushes", 3))),
        "keep_last_results_deltas": int(runtime.get("keep_last_results_deltas", runtime.get("keep_last_flushes", 3))),
        "keep_last_permanent_reviews": int(runtime.get("keep_last_permanent_reviews", runtime.get("keep_last_flushes", 3))),
        "keep_last_progress": int(runtime.get("keep_last_progress", runtime.get("keep_last_flushes", 3))),
        "keep_last_metadata": int(runtime.get("keep_last_metadata", runtime.get("keep_last_flushes", 3))),
        "keep_last_manifests": int(runtime.get("keep_last_manifests", runtime.get("keep_last_flushes", 3))),
        "keep_last_partial_outputs": int(runtime.get("keep_last_partial_outputs", runtime.get("keep_last_flushes", 3))),
        "keep_last_pair_status": int(runtime.get("keep_last_pair_status", runtime.get("keep_last_flushes", 3))),
        "keep_last_traces": int(runtime.get("keep_last_traces", runtime.get("keep_last_flushes", 3))),
        "keep_last_reviews": int(runtime.get("keep_last_reviews", runtime.get("keep_last_flushes", 3))),
